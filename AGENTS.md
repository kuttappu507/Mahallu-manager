...
- Nav transitions: `MainShell` NavHost uses short fade transitions (`fadeIn(tween(220))`/`fadeOut(tween(120))`), NOT slide transitions — slide caused restored tabs to stick at their translation offset (fixed in `e9a6b62`).
